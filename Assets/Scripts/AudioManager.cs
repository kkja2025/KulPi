...
public class AudioManager : MonoBehaviour
{
    ...
    {
        masterMixer.SetFloat("BackgroundVolume", Mathf.Log10(volume) * 20); // Convert to dB scale
    }

    public void SetSoundEffectsVolume(float volume)
    {
        masterMixer.SetFloat("SoundEffectsVolume", Mathf.Log10(volume) * 20); // Convert to dB scale
    }

    public void SetVoiceOverVolume(float volume)
    {
        masterMixer.SetFloat("VoiceOverVolume", Mathf.Log10(volume) * 20); // Convert to dB scale
    }
}
